        ...
        <footer>
            <div className="max-w-screen-xl py-16 mx-auto">
                <div className="grid grid-cols-1 gap-8 text-center mx-auto">
                    <div>
                        <p className="font-signika"><b>IBRAHIM AL WALI</b></p>
                        ...
                        <div className="flex mx-auto">
                            <div className="mx-auto space-x-6 flex mt-8 text-gray-600 dark:text-gray-300">
                                <a className="transition duration-300 hover:opacity-75" href="https://www.instagram.com" target="_blank"
                                    rel="noreferrer">
                                ...
                                <a className="transition duration-300 hover:opacity-75" href="https://www.linkedin.com/in/ibrahim-alwali/" target="_blank"
                                    rel="noreferrer">
                ...
                <p className="mt-8 text-xs text-gray-600 dark:text-gray-300 text-center">
                    © 2023 Based on a Design by <span></span>
